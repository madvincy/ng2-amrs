...
import { Subscription, forkJoin as observableForkJoin, Observable, BehaviorSubject } from 'rxjs';
import { PatientService } from '../services/patient.service';
import { PatientReferralService } from 'src/app/program-manager/patient-referral.service';
...
export class PatientDashboardHomeComponent implements OnInit, OnDestroy {
  @Input()
