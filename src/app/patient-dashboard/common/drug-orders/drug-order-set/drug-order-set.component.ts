...
import { OrderSentenceGeneratorService } from './drug-order-set-draft/order-sentence-generator.service';
...
export class DrugOrderSetComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder, private patientService: PatientService,
    ...
    private orderSentenceGenerator: OrderSentenceGeneratorService,
